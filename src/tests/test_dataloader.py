...
def visualize_data_sample(part="part_A", sigma=5, density_map_size=None, return_count=False):
    ...
    if return_count:
        ...
        plt.colorbar()
        plt.title(f"Density Map (sigma={sigma}, size={density_map.shape}, sum={density_map.sum():.2f})")
...
visualize_data_sample(density_map_size=(192, 192))
